...
function submitNumber() {
  ...
  const scriptURL = 'https://script.google.com/macros/s/AKfycbyWjPUMpVk0YAAYdFGQvsXL9gaf2u2eE6R2ZNG6BfLMO1bReY7Y7hXjHU1aXhbJBiP8vQ/exec'
...
function showAlert(tabName) {
  ...
  switch (tabName) {
    ...
    case 'Instructions':
      ...
      break;
    case 'Contact':
      message = "If you are stuck on this page, please contact us via BeSample and we will provide assistance as quickly as possible.";
      break;
    default:
